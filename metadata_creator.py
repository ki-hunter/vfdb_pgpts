import re
from job_creator import choose_strain_name, filter_ncbi_for_genus
import pandas as pd


# IMG_SAMPLE_ID	SEQUENCING_STATUS	STUDY_NAME	GENOME_NAME	IGZ_CULTURECOLLECTION	SEQUENCING_CENTER	PHYLUM	CLASS	ORDER
# FAMILY	GENUS	SPECIES	GENOME_NAME	GENOME_SIZE	GENE_COUNT	JGI_PROTEIN_COUNT	GENE_DENSITY	JGI_KEGG_PROTEIN_COUNT	IS_PUBLIC	
# NCBI_PROJECT_ID	REFSEQ_PROJECT_ID	BIOTIC_RELATIONSHIP	ECOSYSTEM	ECOSYSTEM_CATEGORY	HOST:PLANT	HOST:HUMAN	HOST:ANIMAL	
# HOST:SOIL	HOST:COMPOST	HOST:ROCK	HOST:FUNGI	HOST:AQUATIC	HOST: ALGAE-PLANKTON	HOST:FOOD	HOST:AIR	
# HOST:BIOTECH/INDUST	HOST:ND		ORGAN:PHYLLOSPHERE	ORGAN:RHIZOSPHERE	ORGAN:FRUIT	ORGAN:FLOWER	ORGAN:SEED	ORGAN:BARK	
# ORGAN:ND	PHEN:PGPT	PHEN:PATHO	PHEN:ND	PGPT	ECOSYSTEM_SUBTYPE	ECOSYSTEM_TYPE	not_announced	HABITAT	ISOLATION	
# HOST_NAME	PHENOTYPE	PUBMED_ID	RELEVANCE	SAMPLE_BODY_SITE	TYPE_STRAIN	GENOME_SIZE	GENE_COUNT	CULTURED	DISEASE	
# ENERGY_SOURCE	GEOGRAPHIC_LOCATION	GRAM_STAINING	ISOLATION_COUNTRY	METABOLISM	MOTILITY	OXYGEN_REQUIREMENT	PH	
# PRESSURE	SALINITY	SPORULATION	TEMPERATURE_RANGE	ANI_CLUSTER_ID	ANI_CLUSTER_TYPE	JGI_PROJECT_ID	GOLD_ANALYSIS_ID	
# GOLD_SEQPROJECT_ID	GOLD_STUDY_ID	NCBI_TAX_ID	REFSEQ_PROJECT_ID	NCBI_PROJECT_ID	NCBI_BIOPROJECT_ID-GBK	NCBI_BIOSAMPLE_ID	
# GENOME_NAME	PMO_PROJECT_ID	REFSEQ_BIOPROJECT_ID	REFSEQ_SAMPLE_ID	REFSEQ_GBK_ACCESSION	REFSEQ_GBK_ID	
# REFSEQ_ASSEMBLY_ACCESSION	REFSEQ_ASSEMBLY_LEVEL	REFSEQ_WGS_MASTER	REFSEQ_TAXID	REFSEQ_SPECIES_ID	REFSEQ_ORGANISM	
# REFSEQ_LINK	GBK_BIOPROJECT_ID	GBK_SAMPLE_ID	GBK_GBK_ACCESSION	GBK_GBK_ID	GBK_ASSEMBLY_ACCESSION	GBK_ASSEMBLY_LEVEL	
# GBK_WGS_MASTER	GBK_TAXID	GBK_SPECIES_ID	GBK_ORGANISM	GBK_LINK	ORGINF_GCF_ID	ORGINF_GCA	ORGINF_KEGG_ORG_ID	
# ORGINF_KEGG_ORG_SYM	ORGINF_SEQUENCE_LEVEL	ORGINF_GENOME_CONTENT	ORGINF_LIFESTYLE	ORGINF_ISOLATION	ORGINF_PUBMED_ID	
# ORGINF_ALL
...
def main():
    ...
    pathogen_count = 0
    filter_result = filter_img_for_genus("kosakonia")
